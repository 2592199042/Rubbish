...
class Garbage_MainWindow(QBeautyUI):
    def __init__(self, *args, obj=None, **kwargs):
        ...
        self.c_video = 0
        self.count_name = ["可回收", "有害", "厨余", "其他", "干垃圾"]
        self.count_table = []
            ...
            if col == 0:  # 点击第一列时
                ...
                if (this_path is not None) & (res is not None) & (axes is not None):
                    ...
                    if os.path.exists(this_path):
                        ...
                        # QtWidgets.QApplication.processEvents()    PYQT提供，功能：一边实现耗时功能一边刷新页面功能
    ...
    def LoadModel(self, model_path=None):
        ...
        parser.add_argument('--weights', nargs='+', type=str, default=r'D:\bishe\GarbageRecognition\Garbage\logs\best.pt',
            ...
            for (dirpath, dirnames, filenames) in os.walk(rootdir):
                for filename in filenames:
                    ...
                    if temp_type == '.png' or temp_type == '.jpg' or temp_type == '.jpeg':
                        ...
                        self.display_image(image)  # 在界面中显示画面
                        QtWidgets.QApplication.processEvents()
                        # self.label_display.display_image
    ...
    def choose_file(self):
        ...
        if fileName_choose != '':
            ...
            yuyin = str(self.names[int(cls)])
            final_yuyin="这是"+yuyin
            import pyttsx3
            # 创建语音引擎
            engine = pyttsx3.init()
            # 设置语速和音量
