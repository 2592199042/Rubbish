...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default=r'/mnt/VOC_rubbish_data/voc_trash.yaml', help='garbage.yaml path')
    ...
    parser.add_argument('--logdir', type=str, default='Garbage/logs', help='logging directory')
